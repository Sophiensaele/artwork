...
#Get new code from the 'staging' branch
sudo git -C /var/www/html fetch --all
sudo git -C /var/www/html checkout staging
sudo git -C /var/www/html pull origin staging
